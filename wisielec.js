...
{
    document.getElementById('plansza_b2').innerHTML = haslo1;
}
...
function start()
{
    ...
    for (i=0; i<35; i++)
        {
            var element = "lit" + i;
            tresc_diva = tresc_diva + '<div class="litera" onclick="sprawdz11('+i+')" id="'+element+'"><b>'+litery[i]+'</b></div>';
            if((i+1) % 7 ==0) tresc_diva = tresc_diva + '<div style="clear: both;"></div>'
        }

    document.getElementById('alfabet_b4').innerHTML = tresc_diva;
